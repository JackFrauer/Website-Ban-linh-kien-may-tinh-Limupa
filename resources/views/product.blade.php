                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">              
                                    @foreach ($image_paths as $path)                          
                                    <div class="sm-image"><img src="{{ asset($path) }}" alt="product image thumb"></div>
                                    @endforeach
                                </div>
                            </div>
                            <!--// Product Details Left -->
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <span class="product-details-ref">{{$product->product_type}}</span>
                                                ...
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="product-details.html">{{$item->product_type}}</a>
                                                        </h5>
                                                    ...
                                                    <h4><a class="product_name" href="{{$item->id}}">{{$item->product_name}}</a></h4>
                                                    <div class="price-box">
